...
def insert_epsilon_edge(wa_original, inp_phrase, out_phrase):
    # print 'wa orgi',wa_original
    # print 'inpt',inp_phrase
    # print 'outp',out_phrase
...
if __name__ == '__main__':
    ...
    if options.input_mt == '' or options.output_mt == '' or options.input_parse == '':
        sys.stderr.write('Useage: python get_basic_edges.py -i MT_INPUT_FILE -o MT_OUTPUT_FILE -p PARSED_MT_INPUT_FILE\n')
        exit(-1)
    else:
        pass
    ...
    coe_sentences = []
    for input_line, output_line, input_parse in zip(input_mt, output_mt, input_parsed)[:1000]:
